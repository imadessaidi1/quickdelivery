    ...
    public SecurityWebFilterChain configureResourceServer(ServerHttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers(HttpMethod.POST, "/users/v1/create-account").permitAll()
                        ...
                        .pathMatchers(HttpMethod.POST, "/packages/v1/payments/stripe/checkout-session**").permitAll()
                        .pathMatchers(HttpMethod.POST, "/packages/v1/payments/stripe/webhook").permitAll()
                        .pathMatchers(HttpMethod.POST, "/packages/v1/estimate-price").permitAll()
                        ...
                        .pathMatchers("/packages/v1/getPackagesByDeliveryPerson**", "/packages/v1/delivery-context**")
