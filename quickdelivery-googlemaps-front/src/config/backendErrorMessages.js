...
const EXACT_MESSAGE_KEYS = {
  ...
  errorActiveRouteCancelledDueToLateStart: 'errorActiveRouteCancelledDueToLateStart',
...
const LOCAL_MESSAGES = {
  en: {
    ...
    errorActiveRouteCancelledDueToLateStart: 'This route was cancelled because it was not started within 30 minutes. A penalty may apply.',
  ...
  fr: {
    ...
    errorActiveRouteCancelledDueToLateStart: 'Cette tournee a ete annulee car elle n a pas ete demarree dans les 30 minutes. Une penalite peut s appliquer.',
