...
const messages = {
  en: {
    ...
    packageAddressFloor: 'Package {state} floor',
    packageAddressFloorStatePickup: 'pickup',
    packageAddressFloorStateDelivery: 'delivery',
    packageAddressDepartureTime: 'Package {state} date & time',
  ...
  //FOOTER LABELS
    ...
    packageAddressFloor: 'Etage de {state} du colis',
    packageAddressDepartureTime: 'Date et heure de {state} du colis',
