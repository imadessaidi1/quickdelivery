...
public interface IPackagesService {
    ...
    void recordGoogleMapsClientCall(String type, double count);
    ...
    PackageDTO reportSenderAbsentForPickup(Long packageID, Long deliveryPersonID, PositionDTO currentPosition);
    PackageDTO reportRecipientAbsentForDelivery(Long packageID, Long deliveryPersonID, PositionDTO currentPosition);
    ...
    PaymentCheckoutSessionDTO createStripeCheckoutSession(Long packageID, String guestAccessToken);
